...
[
\boxed{
\text{「何を avalanche / transport と定義するか」を carefully 再設計する必要がある}
}
]
...
通常の格子SOCや固定ネットワークとはかなり事情が違います。

しかし逆に、

[
\boxed{
\text{escape を含む非平衡重力輸送}
}
]
...
[
\text{nearest-neighbor propagation}
]
...
* particle number in core が変化
* density support が変化
* geometry が time-dependent

になります。

---

# 2. しかしむしろ「transport physics」が強く出る
...
## (B) local Lyapunov burst

finite-time Lyapunov exponent が急増。
...
# これらを avalanche seed にできる。

---

# 4. 「escape」があると geometry はどうなる？
...
[
\boxed{
\text{escape-driven filament transport}
}
]
...
interaction が long-range。

つまり：

[
\text{instantaneous coupling}
]
...
[
\boxed{
\text{network-mediated gravitational transport}
}
]
...
## escaping particle による network 崩壊
...
時刻ごと nearest-neighbor graph 再構築

---

## (C) weighted interaction graph

[
w_{ij}\sim \frac{1}{r_{ij}^\alpha}
]
...
[
\boxed{
\text{gravitational evaporation cascade}
}
]
...
* globular cluster evaporation
* resonant relaxation
* black hole cusp dynamics

とも関連。

---

# 9. 重力系では「criticality」が出やすい
...
# filamentary avalanche

→ resonant escape corridor

---

# front velocity ≈ 0

→ nonlocal gravitational coupling

---

# bottleneck backbone

→ dominant resonant transport channel

---

# strong chaos finite front

→ collective ejection burst
...
# (A) escape avalanche distribution
...
# (C) resonant transport graph

近接 encounter graph。

---

# (D) bound/unbound phase transition
